@AbapCatalog.sqlViewName: 'ZSQL1_PO_HEADER'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #NOT_REQUIRED
@EndUserText.label: 'Header for Adobe form'
@Metadata.ignorePropagatedAnnotations: true
define view ZCD_PO_HEADER11 as select from ekko as Header
  inner join   lfa1 as Vendor on Header.lifnr = Vendor.lifnr
{
 ...
 concat('/sap/opu/odata/sap/ZPO_PDF_SRV/PurchaseOrder(''', concat(ebeln, ''')/$value')) as PdfLink
}
